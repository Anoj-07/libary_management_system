...
urlpatterns = [
    ...
    path("members/", MemberApiViewSet.as_view({"get": "list"})),
    path("members/<int:pk>/", MemberApiViewSet.as_view({"get": "retrieve"})),
] + router.urls
